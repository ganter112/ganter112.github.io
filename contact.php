...
<body>
    ...
    <section class="contact-area" style="margin-top: 150px;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                                    ...
                                    <div class="contact-form-area">
                                        <form class="" action="thanks.php" method="post">
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="contact-name" placeholder="Όνομα">
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="contact-lastname" placeholder="Επώνυμο">
                                            </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control" id="contact-email" placeholder="Email">
                                            </div>
                                            <div class="form-group">
                                                <input type="email" class="form-control" id="contact-phone" placeholder="Αριθμός τηλεφώνου">
                                            </div>
                                            <div class="form-group">
                                                <textarea class="form-control" name="message" id="message" cols="30" rows="10" placeholder="Το κείμενο του σχολίου"></textarea>
                                                <label class="terms-field">
                                                    <input type="checkbox" name="terms" value="check" required=""/>
                                                    <a href="policy.php" target="_blank">
                                                        Έχω διαβάσει και συμφωνώ με τους όρους της συμφωνίας χρήστη
                                                    </a>
                                                </label>
                                            </div>
                                            <button type="submit" class="btn foode-btn">Αποστολή</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-lg-6">
                                <div class="contact-content contact-information">
                                    ...
                                    <div class="single-contact-info d-flex">
                                        ...
                                        <p>9426 Emmitt Radial
Port Lorenahaven, TN 78952-7620</p>
                                    </div>
                                    ...
                                    <div class="single-contact-info d-flex">
                                        ...
                                        <p>info.contact@<span class="server-name"></span></p>
                                    </div>
